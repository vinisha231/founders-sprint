...
(function () {
  ...
  const ENTRIES = [
    ...
    { category: "violent-threat", langs: ["en"], weight: 0.65, re: /\b(i'?m going to (kill|hurt|beat)\s+you|i'?ll kill you|i will hurt you|bring a (gun|knife)|shoot up|you'?re dead)\b/i },
